...
<!-- Canonical source URLs live in each page's frontmatter; readable source lists remain on-page. -->

- [[pages/sources/sc-votes|SC Votes]] - candidate tracking, filing rules, election dates, and official results
- [[pages/sources/anderson-elections|Anderson County elections]] - county election administration and council structure
- [[pages/sources/fec|Federal Election Commission]] - federal campaign finance and committee filings
- [[pages/sources/sc-ethics|South Carolina Ethics Commission]] - state and local campaign disclosures
- [[pages/sources/congress-and-scstatehouse|Congress.gov and South Carolina Legislature]] - officeholding, bills, committees, and votes
- [[pages/sources/federal-disclosures|Federal personal financial disclosures]] - House Clerk and Senate eFD records
- [[pages/sources/candidate-primary-sources|Candidate primary sources]] - campaign sites, filings, and statements
- [[pages/sources/local-news|South Carolina and election news]] - local reporting and event context
- [[pages/sources/ballotpedia|Ballotpedia]] - secondary race index and historical context
- [[pages/sources/open-secrets|OpenSecrets]] - secondary finance and lobbying context
- [[pages/sources/influence-registry|Influence Registry]] - dated, derived federal finance context
- [[pages/sources/secondary-analytical|Secondary and analytical sources]] - ratings, discovery tools, and excluded sources
